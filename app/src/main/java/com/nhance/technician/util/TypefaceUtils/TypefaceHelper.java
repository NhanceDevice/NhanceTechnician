package com.nhance.technician.util.TypefaceUtils;
...
public final class TypefaceHelper {
	...
	public enum FONT{
		NORMAL,LIGHT,BOLD,MEDIUM,THIN,TAHOMA
	}

	public static String getFont(FONT field){
		Map appFont = new EnumMap(FONT.class);
		NhanceApplication na = NhanceApplication.getApplication();
		Resources res = na.getResources();
		//populate the map
		appFont.put(FONT.NORMAL, res.getString(R.string.font_normal));
		appFont.put(FONT.LIGHT, res.getString(R.string.font_light));
		appFont.put(FONT.BOLD, res.getString(R.string.font_bold));
		appFont.put(FONT.MEDIUM, res.getString(R.string.font_medium));
		appFont.put(FONT.THIN, res.getString(R.string.font_thin));
		appFont.put(FONT.TAHOMA, res.getString(R.string.font_tahoma));

		return appFont.get(field).toString();
	}
...
/////////////////////////////////////////////////////////////////////////////////////////////////
	public <V extends View> void setTypeface(V viewGroup, String typefaceName) {
	...
	public <V extends View> void setTypeface(V viewGroup, @StringRes int strResId) {
		setTypeface(viewGroup, mApplication.getString(strResId));
	}

	public <V extends View> void setTypeface(V viewGroup, String typefaceName, int style) {
		int count = ((ViewGroup)viewGroup).getChildCount();
		for (int i = 0; i < count; i++) {
			View child = ((ViewGroup)viewGroup).getChildAt(i);
			if (child instanceof ViewGroup) {
	...
	public <V extends View> void setTypeface(V viewGroup, @StringRes int strResId, int style) {
		setTypeface(viewGroup, mApplication.getString(strResId), style);
	}
/////////////////////////////////////////////////////////////////////////////////////////////////
	 ...
	 * call {@link TypefaceHelper#supportSetTypeface(android.support.v4.app.Fragment, String)} instead.
	 ...
	 * Make sure to call this method after fragment view creation.
	 * If you use fragments in the support package,
	 * call {@link TypefaceHelper#supportSetTypeface(android.support.v4.app.Fragment, String, int)} instead.
	 * @param fragment the fragment.
	 * @param typefaceName typeface name.
	 * @param style the typeface style.
	 */
	...
	public <F extends android.app.Fragment> void setTypeface(F fragment, String typefaceName, int style) {
		...
		if (root instanceof TextInputLayout) {
			setTypeface((TextInputLayout) root, typefaceName, style);
		} else if (root instanceof ViewGroup) {
			setTypeface((ViewGroup) root, typefaceName, style);
		}
	}
	...
	/**
	 * Set the typeface to the target textInputLayout.
	 * @param textInputLayout the set typeface.
	 * @param typefaceName typeface name.
	 */
	public void setTypeface(TextInputLayout textInputLayout, String typefaceName) {
		Typeface typeface = mCache.get(typefaceName);
	 ...
	 * @param strResId string resource containing typeface name.
	 */
	public void setTypeface(TextInputLayout textInputLayout, @StringRes int strResId) {
		setTypeface(textInputLayout, mApplication.getString(strResId));
	}
}
