...
/*
*
* Id: AccessPreferences
*
* Date Author Changes
* 07-Jan-16 afsar Created
*/
...
public final class AccessPreferences {
     ...
     * _in the assignment_ after get() returns*. So don't do_antarctida this :
     *
     * <pre>
    ...
    /**
     * Wraps {@link Editor#clear()}. See its
    ...
    /**
     * Wraps {@link Editor#remove(String)}.
