package com.nhance.technician.networking.downloadmanager.core;
...
import com.nhance.technician.networking.downloadmanager.core.mainWorker.AsyncStartDownload;
import com.nhance.technician.networking.downloadmanager.core.mainWorker.QueueModerator;
import com.nhance.technician.networking.downloadmanager.database.ChunksDataSource;
import com.nhance.technician.networking.downloadmanager.database.DatabaseHelper;
...
import com.nhance.technician.networking.downloadmanager.report.ReportStructure;
import com.nhance.technician.networking.downloadmanager.report.exceptions.QueueDownloadInProgressException;
import com.nhance.technician.networking.downloadmanager.report.exceptions.QueueDownloadNotStartedException;
import com.nhance.technician.networking.downloadmanager.report.listener.DownloadManagerListener;
...
//        dbHelper.close();
     ...
     * @throws com.nhance.technician.networking.downloadmanager.report.exceptions.QueueDownloadNotStartedException
     */
